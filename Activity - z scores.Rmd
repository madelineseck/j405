...
**At the beginning of the week, call volume is high for the first two days. It then shows a consistent decline through the middle of the week, followed by an increase toward the end of the week.**
...
**The data shows, there is extreme spikes in the data with a z-score than drastic drops. **
...
**The day with the highest value stands out because the call count count was exceptionally busier than the usual range for that weekend. **
...
**Some potential angles for reporting include examining whether there were enough police officers available on September 11, 2001, to handle the surge in 9-1-1 calls. The next steps would involve comparing call-volume data to staffing levels on that day. I would also request police records, including the call log, response times between calls, how many officers were dispatched to each incident, and whether the department faced any staffing shortages or met the demand effectively. **
