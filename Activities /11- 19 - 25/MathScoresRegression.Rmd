...
**The scatterplot shows a negative relationship between FARMS percentage and math test scores.**
...
**This model isn’t very useful because the FARMS percentage isn’t a significant predictor of math scores and it explains very little of the correlation between schools. There’s no strong or relationship between FARMS percentage and math performance in this data.**
...
**The biggest differences between the predicted and actual math scores are in the schools with the largest residuals. Schools with big positive residuals did much better than their FARMS percentage would predict, and schools with big negative residuals did much worse than expected.**
...
**Based on this model, I can’tconclude that schools with fewer students on free and reduced-price meals do better on math tests. The FARMS percentage isn’t a significant predictor. Socioeconomic status alone doesn’t  predict math performance. I would look at other factors such as programs, school funding, teachers, or strategies that might explain why some schools perform better. **
