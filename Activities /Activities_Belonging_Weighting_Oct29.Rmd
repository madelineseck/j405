...
**There are parts of the of the survey that misrepresents the population. In class, we talked about population at UMD including students, staff, and faculty is about 53,000. This survery samples about 12,000 people. this is less than half of the population. Also for the minorities, they under catergrized diffent ethic grounps. For example, the Black female persepctive may be different than the Black male persective. :**
...
1. What is the range of weights in this dataset? **3.0386 - 0.2298 = 2.8088 = 2.8:**

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?
**If a respondent has a weight of 0.23, their weight is below 1.0, meaning they are overrepresented and count as less than one person in the population.If a respondent has a weight of 3.04, their weight is above 1.0, meaning they are underrepresented and count as more than one person in the population.:**

3. Why might some respondents be weighted more heavily than others? **There may be more respondents from certain majority groups, so individuals from smaller or underrepresented groups maybe be given higher weights to ensure the survey results reflect all voters. :**
...
1. Which voter category shows the biggest difference between weighted and unweighted results? **rarely/nevercategory shows the biggest difference between weighted and unweighted results, with a −3.56 percentage point change**

2. How might these differences affect reporting on likely voter turnout? **The differences can affect reporiting by leading to inaccurate claims about overall turnout or support for candidates:**

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? **Dfferences after weighting show which groups were over or under-represented in the survey. Weighting corrects for that to make the results more accurate.:**
