...
```{r}
correlation <- cor(gdp_data$GDP, gdp_data$DJIA, use = "complete.obs")
correlation
...
ggplot(gdp_data, aes(x = GDP, y = DJIA)) +
  ...
  labs(
    title = "Scatterplot of DJIA vs GDP",
...
#There is a strong postive correlation betwenn the Dow Jones industrial average and the gross domestic product. As the DJIA goes up the GDP is increasing as well 
