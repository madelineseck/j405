...
**Certain groups enter the sample more easily than others, as people with higher education may be more reachable and more willing to respond to surveys..**
...
**Survey finds higher education leval links to voting intentions**
...
**After applying weights, the percentages shifted only slightly for most education groups. The biggest changes was with  high school education or less. “Yes” responses decreased while their “No” and “Unsure” responses increased.**

2. Why might the weighted results be considered more accurate than the unweighted results?

**Weighted results are considered more accurate because they account for underrepresented groups in the survey. If certain groups are over- or underrepresented in the sample, weighting adjusts it to better reflect the actual population.**
...
**The “High school or less” group shows the largest differences between the weighted and unweighted results.**
...
**It’s important for journalists to understand survey weighting because poll results don’t always reflect the population accurately. Some groups respond at higher rates than others and weighting adjusts for those imbalances so the findings better represent the public.**

2. How might the differences between weighted and unweighted results affect how you would report on this data?
 
**The differences between weighted and unweighted results show why weighting matters for accurate reporting. Unweighted results may over- or underrepresent certain groups, giving a misleading picture of public opinion.**
...
**I would like to know whether the weights account for multiple factors simultaneously education, age, and gender and what population the sample was take from**
