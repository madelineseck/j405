...
**Task 3: Private colleges have the highest average sat score of 1,435. In between are public school with an average score of 1,360 and the scores are communitiy college with with 1,068. University of Maryland is a public school and is slightly higher than the average of private schools with 1,465.:**
...
## Yes, there is a  p-value of 284.3 andsmall p-value of < 2e-16. SAT scores differ significantly across college types. 
   
2. Which specific college types differ from each other? 

## All three college types differ significantly from one another. Private colleges have higher SAT scores than both public and community colleges, and public colleges also score higher than community colleges.

3. How large are these differences?
##Private colleges score about 367 points higher than community colleges, public colleges score about 293 points higher than community colleges, and private colleges score about 74 points higher than public colleges.
