...
**To my surprise, there is a significant decrease in car thefts in 2025. :**
...
- What does the 95% confidence interval show here? **The 95% condidence interval shows the the number  415.1 to 505.7  :**

- What figure(s) accurately reflects the number of car thefts in a typical month? **The figures show an a average of 460 car theft per month with a low of 415 and high of 506:**

- Propose a headline about the trend in car thefts that is focused on the present and future, but informed by the data you see above. ** Prince George County Sees a drop in Car theft**
...
Given the above chart, is the difference between the two periods statistically significant? Can we reject the null hypothesis? **0.189 > 0.05,the difference between the two periods is not statistically significant. :**

How would you revise your headline from Task 6, if at all? What would you tell your editor, and what would you expect her to ask you? ** Car Thefts in Prince George's County vary, no clear trend yet. I would would expect my editor to ask me if we should report this at all, and I would tell her yes, we just to have more data first.:**
